...
impl NanoGptProvider {
    pub fn new() -> Self {
        Self {
            base_url: "https://nano-gpt.com/api/v1".to_owned(),
        }
    }
}
...
mod tests {
    ...
    #[test]
    fn nanogpt_provider_exposes_expected_metadata_and_auth() {
        let provider = NanoGptProvider::new();

        assert_eq!(provider.id(), "nanogpt");
        assert_eq!(provider.base_url(), "https://nano-gpt.com/api/v1");
        assert_eq!(
